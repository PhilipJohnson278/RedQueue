...
set samples {}
while 1 {
    exec redqueue-cli -p $::fail_port debug sleep $::sleep_time > /dev/null &

    # Wait for fail? to appear.
    while 1 {
        set output [exec redqueue-cli -p $::other_port cluster nodes]
    ...
    exec redqueue-cli -p $::fail_port ping
