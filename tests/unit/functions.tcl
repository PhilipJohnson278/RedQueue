...
start_server {tags {"scripting"}} {
    ...
    test {FUNCTION - allow stale} {
        ...
        assert_match {*redqueue_version*} [r fcall f4 0]
    ...
    test {FUNCTION - redqueue version api} {
        r FUNCTION load replace {#!lua name=test
            local version = redis.REDQUEUE_VERSION_NUM
            ...
            redis.register_function{function_name='get_version_v2', callback=function() return redis.REDQUEUE_VERSION end}
        }
